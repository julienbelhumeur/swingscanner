...
if search_btn and search_ticker:
    ...
    with st.spinner(f"Analyse de {ticker_clean}…"):
        ...
        if df_t is None or df_t.empty:
            ...
            rr = abs(target - entry) / abs(entry - stop) if entry and stop and target and abs(entry - stop) > 0 else 0
            ...
            with col_info:
                ...
                <div class='metric-card' style='margin-bottom:12px;'>
                    ...
                    <div style='display:grid; gap:8px; font-family:IBM Plex Mono; font-size:13px;'>
                        <div style='display:flex; justify-content:space-between;'><span style='color:#64748b;'>Entrée suggérée</span><span style='color:#93c5fd;'>{entry:.2f}</span></div>
                        <div style='display:flex; justify-content:space-between;'><span style='color:#64748b;'>Stop-loss</span><span style='color:#f87171;'>{stop:.2f}</span></div>
                        <div style='display:flex; justify-content:space-between;'><span style='color:#64748b;'>Cible (TP)</span><span style='color:#4ade80;'>{target:.2f}</span></div>
                        <div style='border-top:1px solid #1e2230; padding-top:8px; display:flex; justify-content:space-between;'><span style='color:#64748b;'>Ratio R/R</span><span style='color:#fbbf24; font-weight:500;'>{rr:.1f}:1</span></div>
                    </div>
                </div>
